...
> **隐私提示**：图片和文档会上传至百度云端识别。若文件不能离开本机，请使用离线 OCR 工具（如 [Umi-OCR](https://github.com/hiroi-sora/Umi-OCR)）。
...
- **[Umi-OCR](https://github.com/hiroi-sora/Umi-OCR)** — 优秀的离线 OCR 工具，为本项目的产品定位提供了重要参照。
